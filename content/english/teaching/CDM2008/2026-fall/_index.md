...
roadmap:
  ...
  -
    ...
    journey_order: 3
    series: "Design Research Process"
    name: "User Study Design & Execution"
    start_week: 9
    end_week: 11
    weekly_phase_override: "User Study"
    project_number: 1
    schedule_project: "Protocol, pilot, and main study"
    description: "Design the study protocol, pilot it, and conduct the main study."
  -
    ref: "analysis"
    show_in_roadmap: true
    journey_order: 4
    ...
    start_week: 12
    end_week: 13
    weekly_phase_override: "Analysis"
    project_number: 1
    schedule_project: "Findings and evidence-based insights"
    description: "Analyse qualitative and quantitative evidence and develop grounded findings."
  -
    ref: "integrating"
    show_in_roadmap: true
    journey_order: 5
    ...
    start_week: 14
    end_week: 16
    weekly_phase_override: "Integrating"
    project_number: 1
    schedule_project: "Final presentation and research paper"
    description: "Integrate findings into discussion, final presentation, and research paper."
...
resources:
  -
    label: "LearnUS course page"
    status: "Available when the course opens"
  -
    label: "Detailed syllabus"
    status: "To be announced"
  -
    label: "Readings and method templates"
    status: "Added weekly"
  -
    label: "Submission links"
    status: "Added before each deadline"
---
